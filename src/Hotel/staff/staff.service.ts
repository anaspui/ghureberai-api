...
The Ghureberai Team`,
    ...
    async updatestaff(Id: number, Name: string,Password: string,Email:string): Promise<string> {
        const updatestaff = await this.staffRepo.update(Id, { Name,Password,Email });
